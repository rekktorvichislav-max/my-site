...
export function Landing({
  ...
  const featureModules = [
    {
      ...
      chips: [
        "Hit Aura", "Aim Assist", "Auto Totem", "Auto Swap", "Criticals", "Velocity",
        "Trigger Bot", "Anti Bot", "Auto Dodge", "Auto Explosion", "Auto Mace", "Auto Potion",
        "Bow Helper", "Elytra Aura", "Fast Bow", "Hit Box", "Mace Helper", "No Friend Damage",
        "No Interact", "No Server Desync", "No Slot Change", "Pearl Optimizer", "Shift Tap",
        "Tape Mouse", "Target Pearl",
      ],
      mods: [
        ["Hit Aura", t("modHitAura")],
        ["Aim Assist", t("modAimAssist")],
        ...
        ["Anti Bot", t("modAntiBot")],
        ["Auto Dodge", t("modAutoDodge")],
        ["Auto Explosion", t("modAutoExplosion")],
        ["Auto Mace", t("modAutoMace")],
        ["Auto Potion", t("modAutoPotion")],
        ["Bow Helper", t("modBowHelper")],
        ["Elytra Aura", t("modElytraAura")],
        ["Fast Bow", t("modFastBow")],
        ["Hit Box", t("modHitBox")],
        ["Mace Helper", t("modMaceHelper")],
        ["No Friend Damage", t("modNoFriendDamage")],
        ["No Interact", t("modNoInteract")],
        ["No Server Desync", t("modNoServerDesync")],
        ["No Slot Change", t("modNoSlotChange")],
        ["Pearl Optimizer", t("modPearlOptimizer")],
        ["Shift Tap", t("modShiftTap")],
        ["Tape Mouse", t("modTapeMouse")],
        ["Target Pearl", t("modTargetPearl")],
      ],
    },
    {
      ...
      chips: [
        "Sprint", "Long Jump", "Fly", "Elytra Booster", "Elytra Fly", "Jesus", "Strafe",
        "Fast Break", "Inv Move", "KT Leave", "No Crouch", "No Slow", "No Web", "Parkour",
        "Safe Walk", "Spider", "Wall Climb", "Water Speed",
      ],
      mods: [
        ["Sprint", t("modSprint")],
        ...
        ["Elytra Fly", t("modElytraFly")],
        ["Jesus", t("modJesus")],
        ["Strafe", t("modStrafe")],
        ["Fast Break", t("modFastBreak")],
        ["Inv Move", t("modInvMove")],
        ["KT Leave", t("modKtLeave")],
        ["No Crouch", t("modNoCrouch")],
        ["No Slow", t("modNoSlow")],
        ["No Web", t("modNoWeb")],
        ["Parkour", t("modParkour")],
        ["Safe Walk", t("modSafeWalk")],
        ["Spider", t("modSpider")],
        ["Wall Climb", t("modWallClimb")],
        ["Water Speed", t("modWaterSpeed")],
      ],
    },
    {
      ...
      chips: [
        "Auto Gapple", "Auto Brewer", "Apple Farm", "Chest Stealer", "Auto Armor", "Auto Tool",
        "Air Stuck", "Auto Accept", "Auto Auth", "Auto Eat", "Auto Fish", "Auto Leave",
        "Auto Respawn", "Blink", "Death Coords", "Elytra Helper", "Fake Player", "Fast EXP",
        "Lock Slot", "Middle Click", "No Delay", "No Push", "No Rotate", "SP Joiner", "Timer",
        "Wind Hop",
      ],
      mods: [
        ...
        ["Air Stuck", t("modAirStuck")],
        ["Auto Accept", t("modAutoAccept")],
        ["Auto Auth", t("modAutoAuth")],
        ["Auto Eat", t("modAutoEat")],
        ["Auto Fish", t("modAutoFish")],
        ["Auto Leave", t("modAutoLeave")],
        ["Auto Respawn", t("modAutoRespawn")],
        ["Blink", t("modBlink")],
        ["Death Coords", t("modDeathCoords")],
        ["Elytra Helper", t("modElytraHelper")],
        ["Fake Player", t("modFakePlayer")],
        ["Fast EXP", t("modFastExp")],
        ["Lock Slot", t("modLockSlot")],
        ["Middle Click", t("modMiddleClick")],
        ["No Delay", t("modNoDelay")],
        ["No Push", t("modNoPush")],
        ["No Rotate", t("modNoRotate")],
        ["SP Joiner", t("modSpJoiner")],
        ["Timer", t("modTimer")],
        ["Wind Hop", t("modWindHop")],
      ],
    },
    {
      ...
      chips: [
        "ESP", "Target ESP", "Tracers", "NameTags", "Trails", "ViewModel", "Aspect Ratio",
        "Block ESP", "Board Spoofer", "Custom World", "Fullbright", "Glow Cubes", "Glow ESP",
        "Hat", "Item ESP", "Item Physic", "Jump Circle", "No Render", "Particles",
        "Projectile Prediction", "See Invisibles", "Shulker Preview", "Skin Manager", "Snow",
        "Storage ESP", "Swim Animation", "Swing Animation",
      ],
      mods: [
        ["ESP", t("modEsp")],
        ...
        ["Aspect Ratio", t("modAspectRatio")],
        ["Block ESP", t("modBlockEsp")],
        ["Board Spoofer", t("modBoardSpoofer")],
        ["Custom World", t("modCustomWorld")],
        ["Fullbright", t("modFullbright")],
        ["Glow Cubes", t("modGlowCubes")],
        ["Glow ESP", t("modGlowEsp")],
        ["Hat", t("modHat")],
        ["Item ESP", t("modItemEsp")],
        ["Item Physic", t("modItemPhysic")],
        ["Jump Circle", t("modJumpCircle")],
        ["No Render", t("modNoRender")],
        ["Particles", t("modParticles")],
        ["Projectile Prediction", t("modProjectilePrediction")],
        ["See Invisibles", t("modSeeInvisibles")],
        ["Shulker Preview", t("modShulkerPreview")],
        ["Skin Manager", t("modSkinManager")],
        ["Snow", t("modSnow")],
        ["Storage ESP", t("modStorageEsp")],
        ["Swim Animation", t("modSwimAnimation")],
        ["Swing Animation", t("modSwingAnimation")],
      ],
    },
    {
    ...
    {
      title: t("featUtilityTitle"),
      desc: t("featUtilityDesc"),
      chips: [
        "Anti AFK", "Auto Buy", "Auto TP Accept", "Auto Warden", "Chat Helper", "Clan Upgrader",
        "Fake Lags", "FreeCam", "Hit Sound", "Item Scroller", "Leave Tracker", "No Hurt Cam",
        "Optimizer", "Server Helper", "Sounds", "Use Tracker", "Zoom",
      ],
      mods: [
        ["Anti AFK", t("modAntiAfk")],
        ["Auto Buy", t("modAutoBuy")],
        ["Auto TP Accept", t("modAutoTpAccept")],
        ["Auto Warden", t("modAutoWarden")],
        ["Chat Helper", t("modChatHelper")],
        ["Clan Upgrader", t("modClanUpgrader")],
        ["Fake Lags", t("modFakeLags")],
        ["FreeCam", t("modFreeCam")],
        ["Hit Sound", t("modHitSound")],
        ["Item Scroller", t("modItemScroller")],
        ["Leave Tracker", t("modLeaveTracker")],
        ["No Hurt Cam", t("modNoHurtCam")],
        ["Optimizer", t("modOptimizer")],
        ["Server Helper", t("modServerHelper")],
        ["Sounds", t("modSounds")],
        ["Use Tracker", t("modUseTracker")],
        ["Zoom", t("modZoom")],
      ],
    },
    {
  ...
  return (
    <div className={drun ? "axion-drunk-page" : undefined}>
      <style>{`
      ...
      >
        <div style={{ fontSize: 22, fontWeight: 800, textShadow: "0 0 18px rgba(255,255,255,0.25)" }}>
          {drun && <span className="axion-drunk-logo">🍺</span>}
      ...
      >
        © {new Date().getFullYear()} Axion Client. {t("rightsReserved")}
      </footer>
    </div>
  );
}
